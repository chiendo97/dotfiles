...
```bash
uv run "${AGENTS_SKILLS_DIR:-$HOME/.agents/skills}/youtube-gemini/scripts/youtube_gemini.py" '<youtube-url>'
```
...
```bash
uv run "${AGENTS_SKILLS_DIR:-$HOME/.agents/skills}/youtube-gemini/scripts/youtube_gemini.py" \
  '<youtube-url>' \
